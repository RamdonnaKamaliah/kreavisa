...
@section('content')
    <div class="relative overflow-x-hidden">
        <div>
            <div class="flex-1 p-6 max-w-7xl mx-auto text-gray-900 overflow-hidden">
                <div class="flex flex-wrap -mx-3 items-stretch">
                    <!-- Card 1 - Total Kehadiran -->
                    <div class="w-1/2 xl:w-1/4 px-3 mb-6">
                        <div
                            class="relative flex flex-col min-w-0 h-full break-words bg-white dark:bg-slate-850 shadow-xl dark:shadow-dark-xl rounded-2xl bg-clip-border transition-transform hover:scale-105">
                            <div class="flex-auto p-4 min-h-[120px]">
                                <div class="flex flex-row -mx-3">
                                    <div class="flex-none w-2/3 max-w-full px-3">
                                        <p
                                            class="mb-0 text-sm font-semibold uppercase dark:text-white dark:opacity-60 whitespace-nowrap">
                                            Total <br> Kehadiran
                                        </p>
                                    ...
                                    <div
                                        class="px-3 text-right basis-1/3 -translate-x-2 sm:translate-x-0 transition-transform duration-200">
                                        <div
                        ...
                        <div
                            ...
                            <div class="flex-auto p-4 min-h-[120px]">
                                <div class="flex flex-row -mx-3">
                                    ...
                                    <div
                                        class="px-3 text-right basis-1/3 -translate-x-4 sm:translate-x-0 transition-transform duration-200">
                                        <div
                        ...
                        <div
                            ...
                            <div class="flex-auto p-4 min-h-[120px]">
                                <div class="flex flex-row -mx-3">
                                    ...
                                    <div
                                        class="px-3 flex justify-end basis-1/3 -translate-x-4 sm:translate-x-0 transition-transform duration-200">
                                        <div
                                            class="inline-flex items-center justify-center w-12 h-12 rounded-full bg-gradient-to-tl from-sky-500 to-slate-400 overflow-hidden">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 px-4 sm:px-6 -mt-8">
