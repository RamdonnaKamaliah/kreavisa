...
@section('page-title', 'Absen Sakit')
@section('content')
    <div class="p-4 md:p-6 overflow-x-hidden">
        <div class="bg-white dark:bg-slate-850 dark:shadow-dark-xl text-gray-900 p-4 rounded-lg shadow-md">
            ...
            <form action="{{ route('karyawan.absen.sakit.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <input type="hidden" name="lokasi" id="lokasi">

                <!-- Upload Bukti Sakit Section -->
                <div class="mb-8">
                    <label class="block text-gray-700 text-sm font-medium mb-4 text-center dark:text-gray-300">Upload Bukti
                        Sakit</label>
                    ...
                    <div class="flex flex-col items-center space-y-4">
                        ...
                        <div class="w-full max-w-lg">
                            <label for="file"
                                ...
                                <input id="file" name="file" type="file" class="hidden" accept=".jpg,.png,.pdf"
                                    required>
                            </label>
                        </div>
                        ...
                        <div id="filePreview" class="hidden w-full max-w-xs">
                            <div class="border border-gray-200 rounded-lg p-3 flex items-center justify-between">
                                <div class="flex items-center space-x-3">
                                    ...
                                    <div>
                                        <p id="fileName"
                                            class="text-sm font-medium text-gray-700 truncate dark:text-white"></p>
