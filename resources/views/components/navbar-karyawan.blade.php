<aside
    class="w-64 h-screen fixed left-0 top-0 bg-white dark:bg-[#1D232A] text-gray-900 shadow-md p-4 flex flex-col">
    <style>
            ...
            <ul class="space-y-2">
                ...
                {{ $isActive ? 'bg-blue-100 dark:bg-blue-800 text-blue-600 dark:text-blue-300' : 'hover:bg-gray-200 dark:hover:bg-gray-700' }}">
                    ...
                    {{ $isActive ? 'block' : 'hidden group-hover:block' }}">
                            ...
                            {{-- ICON (selalu berwarna, tidak terpengaruh mode) --}}
                            <i data-lucide="{{ $menu['icon'] }}" class="w-5 h-5 {{ $menu['color'] }}"></i>

                            {{-- TEXT (ubah sesuai dark mode) --}}
