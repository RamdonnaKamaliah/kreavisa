...
<div id="wrapper">
    <!-- Sidebar -->
    <ul class="navbar-nav bg-custom-red sidebar sidebar-light accordion" id="accordionSidebar">
        <!-- Sidebar - Brand -->
        ...
        <!-- Jabatan Karyawan -->
        <li class="nav-item">
            <a class="nav-link" href="jabatan-karyawan.html">
        ...
        <!-- Gaji Karyawan -->
        <li class="nav-item">
            <a class="nav-link" href="gaji-karyawan.html">
