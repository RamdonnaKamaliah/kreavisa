        ...
        <div class="bg-white rounded-2xl shadow-lg flex flex-col md:flex-row overflow-hidden w-full max-w-4xl md:ml-20">
            ...
            <div class="md:w-1/2 p-8 flex flex-col justify-center">
                <h1 class="text-2xl font-bold text-gray-900 mb-6 flex items-center">
                    <i class="fa-solid fa-user mr-2"></i> Login Karyawan
                </h1>
                ...
                <form method="POST" action="{{ route('login.karyawan.process') }}" class="space-y-4">
                    ...
                    <div class="relative">
                        ...
                        <button type="button" class="absolute inset-y-0 right-0 pr-3 flex items-center text-gray-500"
                            ...
                            <!-- Heroicon: eye-off (tampil saat load) -->
                    ...
                    <script>
                        function togglePassword() {
                            ...
                            if (pwd.type === 'password') {
                                // ubah ke text (tampil), swap ikon
                                pwd.type = 'text';
                                eye.classList.remove('hidden');
                                eyeOff.classList.add('hidden');
                            } else {
                                // ubah ke password (sembunyi), swap ikon
                                pwd.type = 'password';
