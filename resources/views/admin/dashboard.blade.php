    ...
    <div class="w-full px-6 py-6 mx-auto">
                        ...
                        <div class="flex flex-row -mx-3">
                            <div class="flex-none w-2/3 max-w-full px-3">
                                <div>
                                    ...
                                    <div class="text-left">
                                        <p id="temperature" class="text-3xl mt-4 font-semibold text-black dark:text-white">
                                            --°C
                                        </p>
                                        <p id="weatherDescription" class="mt-8 font-bold text-gray-600 dark:text-white">
                                            Memuat...</p>
                                    </div>
        ...
        <div class="flex flex-col md:flex-row justify-center gap-8 ml-4">
            ...
            <div
                ...
                <h2 class="text-lg font-bold mb-4 text-center text-black dark:text-white">Jumlah Karyawan
                </h2>
                <div class="flex flex-row justify-center items-center gap-8">
                    ...
                    <div class="p-5 bg-gray-100 dark:bg-gray-700 rounded-lg shadow text-left w-60">
                        <h3 class="text-base font-semibold mb-3 text-black dark:text-white">Jumlah Karyawan
                            Berdasarkan Jabatan</h3>
                        <ul class="text-sm text-black dark:text-white">
            ...
            <div
                ...
                <h2 class="text-lg font-bold mb-4 text-black dark:text-white">Total Absensi Minggu Ini</h2>
