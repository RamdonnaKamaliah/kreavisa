...
<div id="layoutSidenav_content">
    <div id="layoutSidenav_content">
        <main>
            <div id="layoutSidenav_content">
                <h1 class="container text-center my-4" style="font-family: 'Arial', sans-serif; color: #333;">Create Data
                    Karyawan</h1>
                ...
                <form class="admin-form container" action="#" method="POST" enctype="multipart/form-data"
                    ...
                    <div class="mb-3">
                        <label for="name" class="form-label" style="font-weight: bold; color: #495057;">Nama</label>
