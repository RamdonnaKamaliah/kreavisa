        ...
        <main class="flex justify-center py-6 p-6">
            <div class="w-full max-w-4xl space-y-6">
                ...
                <div class="bg-white dark:bg-slate-800 p-6 rounded-lg shadow-lg">
                    ...
                    <form action="{{ route('datakaryawan.import') }}" method="POST" enctype="multipart/form-data" class="space-y-4">
                        @csrf
                        <div>
                        <div class="flex items-stretch rounded-lg border border-gray-300 dark:border-gray-600 overflow-hidden">
    <!-- File input with custom styling -->
    <label class="flex-1 cursor-pointer bg-gray-50 dark:bg-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 transition">
        <div class="px-4 py-2 flex items-center">
            <span class="text-sm text-gray-700 dark:text-gray-300 mr-2">Choose file</span>
            <span class="text-xs text-gray-500 dark:text-gray-400 truncate" id="file-name">No file chosen</span>
            <input type="file" name="file" class="hidden" required accept=".xlsx,.xls,.csv" onchange="document.getElementById('file-name').textContent = this.files[0]?.name || 'No file chosen'">
        </div>
    </label>
    
    <!-- Upload button -->
    <button type="submit" class="bg-blue-400 text-white px-4 hover:bg-blue-700 transition flex items-center">
    ...
    document.querySelector('input[type="file"]').addEventListener('change', function() {
        document.getElementById('file-name').textContent = this.files[0]?.name || 'No file chosen';
                        ...
                        <div class="pt-2">
                            ...
                            <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">Gunakan template ini untuk format yang benar</p>
                        </div>
                    </form>
                </div>
                ...
                <div class="bg-white dark:bg-slate-800 p-6 rounded-lg shadow-lg">
                    ...
                    <form action="{{ route('datakaryawan.store') }}" method="POST" enctype="multipart/form-data" class="space-y-4">
                        @csrf
                        <div class="text-center">
                            <label for="foto" class="cursor-pointer inline-block">
                                <img id="preview" src="{{ asset('asset-landing-page/img/profile.png') }}" alt="Upload Foto"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <div class="space-y-4">
                                <div>
                                    <label for="nama_lengkap" class="block text-gray-700 font-medium dark:text-gray-300">Nama Lengkap<span class="text-red-500">*</span></label>
                                ...
                                <div>
                                    <label for="email" class="block text-gray-700 font-medium dark:text-gray-300">Email<span class="text-red-500">*</span></label>
                                    <input name="email" type="email" id="email" placeholder="Input Email"
                                        class="w-full p-3 border rounded-lg focus:ring-2 focus:ring-blue-400">
                                </div>
                                
                                <div>
                                    <label for="dob" class="block text-gray-700 font-medium dark:text-gray-300">Tanggal Lahir<span class="text-red-500">*</span></label>
                            ...
                            <div class="space-y-4">
                                <div>
                                    <label for="name" class="block text-gray-700 font-medium dark:text-gray-300">Username<span class="text-red-500">*</span></label>
                                    <input type="text" id="name" name="name" placeholder="Input Username"
                                        class="w-full p-3 border rounded-lg focus:ring-2 focus:ring-blue-400">
                                </div>
                                
                                <div>
                                    <label for="phone" class="block text-gray-700 font-medium dark:text-gray-300">No Telpon<span class="text-red-500">*</span></label>
                            ...
                            <div class="space-y-4">
                                <div>
                                    <label for="gender" class="block text-gray-700 font-medium dark:text-gray-300">Gender<span class="text-red-500">*</span></label>
                                ...
                                <div>
                                    <label for="position" class="block text-gray-700 font-medium dark:text-gray-300">Jabatan<span class="text-red-500">*</span></label>
