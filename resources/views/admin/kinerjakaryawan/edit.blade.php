@extends('layout.main')
@section('page-title', 'Edit Kinerja Karyawan')
@section('content')
                    ...
                    <div class="row p-4">
                        <div class="col-md-12 mb-4">
                            <div class="form-group">
                                <label
                                    class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Karyawan</label>
                                <div class="mt-1 border border-gray-300 rounded-md p-2 dark:border-gray-600">
                                    <p class="text-gray-700 dark:text-gray-300">
                                        {{ $kinerjaKaryawan->user->nama_lengkap }} -
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-2">
                                <div>
                                    ...
                                    <input type="date" name="tanggal_penilaian"
                                        value="{{ old('tanggal_penilaian', $kinerjaKaryawan->tanggal_penilaian) }}"
                                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-gray-700 dark:border-gray-600">
                                </div>
                                <div>
                                    <label class="text-sm text-gray-600 dark:text-gray-300">Periode:</label>
                                    <input type="text" name="periode"
                                        value="{{ old('periode', $kinerjaKaryawan->periode) }}"
                                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-gray-700 dark:border-gray-600">
                                </div>
                            </div>
                        </div>
