            ...
            <div class="row p-4">
                <div class="col-md-12 mb-4">
                    <div class="form-group">
                        ...
                        <div
                            class="mt-1 border border-gray-300 rounded-md p-2 dark:border-gray-600 bg-gray-50 dark:bg-gray-700">
                                        ...
                                        <tbody class="divide-y divide-gray-300 dark:divide-gray-600">
                                            ...
                                            <tr>
                                                ...
                                                <td
                                                    ...
                                                    Tanggung Jawab</td>
                                                <td class="px-4 py-3">Kemampuan menyelesaikan tugas dengan bertanggung jawab
                                                    dan mandiri</td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="px-4 py-3">Konsistensi kehadiran dan ketepatan waktu dalam
                                                    menyelesaikan tugas</td>
                                                <td class="px-4 py-3 text-center">
                                                    <span
                                                        class="inline-block px-3 py-1 rounded-full 
                                            ...
                                            <tr>
                                                ...
                                                <td
                                                    class="px-4 py-3 font-medium sticky left-10 bg-white dark:bg-slate-800 z-10">
                                                    Produktivitas</td>
                                                <td class="px-4 py-3">Kuantitas dan kualitas hasil kerja dalam periode
                                                    penilaian</td>
                                                <td class="px-4 py-3 text-center">
                                                    <span
                                                        class="inline-block px-3 py-1 rounded-full 
                                            ...
                                            <tr>
                                                ...
                                                <td
                                                    class="px-4 py-3 font-medium sticky left-10 bg-white dark:bg-slate-800 z-10">
                                                    Kerja Sama Tim</td>
                                                <td class="px-4 py-3">Kemampuan bekerja sama dalam tim dan berkolaborasi
                                                </td>
                                                <td class="px-4 py-3 text-center">
                                                    <span
                                                        class="inline-block px-3 py-1 rounded-full 
                                            ...
                                            <tr>
                                                ...
                                                <td class="px-4 py-3">Kemampuan menyampaikan ide dan berinteraksi dengan
                                                    rekan kerja</td>
                                                <td class="px-4 py-3 text-center">
                                                    <span
                                                        class="inline-block px-3 py-1 rounded-full 
                                            ...
                                            <!-- Total Score -->
                                            <tr>
                                                <td class="px-4 py-3 sticky left-0 bg-gray-200 dark:bg-gray-700 z-10 font-bold"
