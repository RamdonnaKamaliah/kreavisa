    ...
    <div class="p-4 md:p-6 overflow-x-hidden">
        <div class="flex justify-center items-center min-h-screen py-10">
            <div class="w-full max-w-4xl bg-white p-8 rounded-lg shadow-lg">
                ...
                <h1 class="text-center text-2xl font-bold text-gray-800 mb-6">Edit Gaji Karyawan</h1>
                <form action="{{ route('gajikaryawan.update', $gajiKaryawan->id) }}" method="POST" class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    @csrf
                    @method('PUT')

                    <div>
                        <label class="block text-gray-700 font-medium">Nama Karyawan</label>
                    ...
                    <div>
                        <label class="block text-gray-700 font-medium">Gaji Pokok</label>
                    ...
                    <div id="rekening-container">
                        <label class="block text-gray-700 font-medium">Nomor Rekening</label>
                    ...
                    <div>
                        <label class="block text-gray-700 font-medium">Bonus (Rp)</label>
                    ...
                    <div>
                        <label class="block text-gray-700 font-medium">Potongan (Rp)</label>
