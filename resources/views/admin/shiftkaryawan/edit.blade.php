            ...
            <form action="{{ route('shiftkaryawan.update', $shift->id) }}" method="POST">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 border-t border-gray-300 pt-4">
                    ...
                    <div class="pr-4">
                        ...
                        <div class="space-y-2">
                            <div>
                                <label for="shift_1_masuk" class="block text-gray-700">Jam Masuk</label>
                            ...
                            <div>
                                <label for="shift_1_pulang" class="block text-gray-700">Jam Pulang</label>
                    ...
                    <div class="pl-4">
                        ...
                        <div class="space-y-2">
                            <div>
                                <label for="shift_2_masuk" class="block text-gray-700">Jam Masuk</label>
                                <input type="text" id="shift_2_masuk" name="shift_2_masuk" 
                                       class="timepicker w-full p-2 border border-gray-400 rounded-md"
                                       value="{{ explode(' - ', $shift->shift_2 ?? '')[0] ?? '' }}" required>
                            </div>
                            <div>
                                <label for="shift_2_pulang" class="block text-gray-700">Jam Pulang</label>
