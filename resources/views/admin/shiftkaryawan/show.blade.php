@extends('layout.main')
@section('page-title', 'View Shift Karyawan')
@section('content')
        ...
        <div class="bg-white dark:bg-slate-800 text-gray-900 p-4 rounded-lg shadow-md border border-gray-300 dark:border-slate-800 max-w-2xl mx-auto">
            ...
            <div class="flex justify-between items-start mb-2 pb-4">
                <div class="w-1/2 pr-2">
                    <h2 class="text-lg font-bold dark:text-white">Nama:</h2>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 border-t border-gray-300 pt-4">
                ...
                <div class="pr-4">
                    ...
                    <div class="space-y-2">
                        <div>
                            <label class="block text-gray-700 dark:text-gray-300">Jam Masuk</label>
                            <div class="w-full p-2 border border-gray-300 rounded-md bg-gray-50">
                                {{ explode(' - ', $shift->shift_1 ?? '')[0] ?? '-' }}
                            </div>
                        </div>
                        <div>
                            <label class="block text-gray-700 dark:text-gray-300">Jam Pulang</label>
                            <div class="w-full p-2 border border-gray-300 rounded-md bg-gray-50">
