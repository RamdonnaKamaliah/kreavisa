...
class GudangAbsenController extends Controller
{
    /**
    ...
    public function index()
{
    ...
    return view('gudang.absen.index', [
    ...
    public function create()
    {
        ...
        return view('gudang.absen.create');
    }
...
if ($todayAbsen) {
    ...
    return redirect()->route('gudang.absen.index')
    ...
    {
        return view('gudang.absen.create-sakit');
    }
...
->with('attendance_type', 'sakit');
    ...
    {
        return view('gudang.absen.create-izin');
    }
...
->with('attendance_type', 'izin');
    ...
    public function show(string $id)
    {
        ...
        return view('gudang.absen.show', compact('absen'));
    }
    ...
    public function edit(string $id)
    {
        ...
        $absen = AbsenKaryawan::findOrFail($id);
        return view('gudang.absen.edit', compact('absen'));
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        return redirect()->route('gudang.absen.index')->with('success', 'Absen berhasil diperbarui.');
    }
    ...
    public function destroy(string $id)
    {
        ...
        return redirect()->route('gudang.absen.index')->with('success', 'Absen berhasil dihapus.');
    }
}